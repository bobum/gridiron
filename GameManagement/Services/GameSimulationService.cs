...
public class EngineSimulationService : IEngineSimulationService
{
    ...
    /// <param name="playByPlayLogger">Optional logger for capturing play-by-play output.</param>
    /// <returns>Simulation result with updated team data.</returns>
    public EngineSimulationResult SimulateGame(Team homeTeam, Team awayTeam, int? randomSeed = null, ILogger? playByPlayLogger = null)
    {
...
{
    EngineSimulationResult SimulateGame(Team homeTeam, Team awayTeam, int? randomSeed = null, ILogger? playByPlayLogger = null);
}
