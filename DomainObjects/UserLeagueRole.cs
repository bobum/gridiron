...
public class UserLeagueRole : SoftDeletableEntity
{
    ...
    /// <summary>
    /// Gets or sets the user being assigned a role.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the league this role applies to.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the role this user has in the league (Commissioner or GM).
    /// </summary>
    public UserRole Role { get; set; }

    /// <summary>
    /// Gets or sets if Role is GeneralManager, this is the specific team they manage.
