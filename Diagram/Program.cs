...
var gridironSystem = model.AddSoftwareSystem(
    "Gridiron Simulation System",
...
// External systems
var azureSql = model.AddSoftwareSystem(
    "Azure SQL Database",
    "Stores teams, players, games, and play-by-play data");
var loggingSystem = model.AddSoftwareSystem(
    "Logging System",
...
// LEVEL 2: CONTAINERS
// ================================================================================
var domainObjects = gridironSystem.AddContainer(
    "DomainObjects",
...
var diagramGen = gridironSystem.AddContainer(
    "Diagram",
...
var stateEnum = stateLibrary.AddComponent(
    ...
    "Enum");
var triggerEnum = stateLibrary.AddComponent(
    "Trigger (enum)",
...
var preGameAction = stateLibrary.AddComponent(
    "PreGame (Action)",
    "Pregame festivities and setup.",
    "C# Class");
var coinTossAction = stateLibrary.AddComponent(
    "CoinToss (Action)",
    "Executes coin toss, determines possession with deferral logic.",
    "C# Class");
var prePlayAction = stateLibrary.AddComponent(
    "PrePlay (Action)",
    "Determines play type, checks pre-snap penalties, executes snap.",
    "C# Class");
var snapAction = stateLibrary.AddComponent(
    "Snap (Action)",
    "Snap skills check (bad snap possibility).",
    "C# Class");
var postPlayAction = stateLibrary.AddComponent(
    "PostPlay (Action)",
    "Checks during/after penalties, scores, injuries, quarter expiration.",
    "C# Class");

// Play execution
var runExecution = stateLibrary.AddComponent(
    "Run (Play)",
    "Executes run play: blocking, direction, yards, breakaway, fumbles, injuries.",
    "C# Class");
var passExecution = stateLibrary.AddComponent(
    "Pass (Play)",
    "Executes pass play: protection, completion, interception, YAC, sacks, injuries.",
    "C# Class");
var kickoffExecution = stateLibrary.AddComponent(
    "Kickoff (Play)",
    "Executes kickoff: distance, touchback, return, onside kick, injuries.",
    "C# Class");
var puntExecution = stateLibrary.AddComponent(
    "Punt (Play)",
    "Executes punt: distance, hang time, block, fair catch, return, injuries.",
    "C# Class");
var fieldGoalExecution = stateLibrary.AddComponent(
    "FieldGoal (Play)",
    "Executes field goal: distance calculation, block check, make/miss.",
    "C# Class");

// Play results
var runResult = stateLibrary.AddComponent(
    "RunResult",
    "Processes run play: updates field position, checks first down, TD, safety.",
    "C# Class");
var passResult = stateLibrary.AddComponent(
    "PassResult",
    "Processes pass play: updates field position, checks first down, TD, safety, interceptions.",
    "C# Class");
var kickoffResult = stateLibrary.AddComponent(
    "KickoffResult",
    "Processes kickoff: updates possession, field position.",
    "C# Class");
var puntResult = stateLibrary.AddComponent(
    "PuntResult",
    "Processes punt: updates possession, field position, checks safety.",
    "C# Class");
var fieldGoalResult = stateLibrary.AddComponent(
    "FieldGoalResult",
    "Processes field goal: updates score, possession.",
    "C# Class");

// Skills checks (25+)
var passCompletionCheck = stateLibrary.AddComponent(
    "PassCompletionSkillsCheck",
    "Determines if pass is completed based on QB passing, receiver catching, coverage.",
    "C# Class");
var passProtectionCheck = stateLibrary.AddComponent(
    "PassProtectionSkillsCheck",
    "Determines if QB is sacked based on O-line blocking vs D-line pressure.",
    "C# Class");
var interceptionCheck = stateLibrary.AddComponent(
    "InterceptionOccurredSkillsCheck",
    "Determines if pass is intercepted (only checked on incomplete passes).",
    "C# Class");
var blockingSuccessCheck = stateLibrary.AddComponent(
    "BlockingSuccessSkillsCheck",
    "Determines run blocking effectiveness (O-line vs D-line).",
    "C# Class");
var tackleBreakCheck = stateLibrary.AddComponent(
    "TackleBreakSkillsCheck",
    "Determines if ball carrier breaks tackle for extra yards.",
    "C# Class");
var bigRunCheck = stateLibrary.AddComponent(
    "BigRunSkillsCheck",
    "Determines if run becomes breakaway (15-44 extra yards).",
    "C# Class");
var fumbleOccurredCheck = stateLibrary.AddComponent(
    "FumbleOccurredSkillsCheck",
    "Determines if fumble occurs based on ball carrier, tacklers, gang tackles.",
    "C# Class");
var fumbleRecoveryCheck = stateLibrary.AddComponent(
    "FumbleRecoverySkillsCheckResult",
    "Determines who recovers fumble (possession change logic).",
    "C# Class");
var yardsAfterCatchCheck = stateLibrary.AddComponent(
    "YardsAfterCatchSkillsCheck",
    "Calculates yards after catch based on receiver speed, agility, defense.",
    "C# Class");
var fieldGoalMakeCheck = stateLibrary.AddComponent(
    "FieldGoalMakeOccurredSkillsCheck",
    "Determines if field goal is made based on distance, kicker skill.",
    "C# Class");
var fieldGoalBlockCheck = stateLibrary.AddComponent(
    "FieldGoalBlockOccurredSkillsCheck",
    "Determines if field goal is blocked.",
    "C# Class");
var puntDistanceCheck = stateLibrary.AddComponent(
    "PuntDistanceSkillsCheckResult",
    "Calculates punt distance based on punter skill.",
    "C# Class");
var puntBlockCheck = stateLibrary.AddComponent(
    "PuntBlockOccurredSkillsCheck",
    "Determines if punt is blocked.",
    "C# Class");
var fairCatchCheck = stateLibrary.AddComponent(
    "FairCatchOccurredSkillsCheck",
    "Determines if returner calls fair catch.",
    "C# Class");
var muffedCatchCheck = stateLibrary.AddComponent(
    "MuffedCatchOccurredSkillsCheck",
    "Determines if returner muffs catch (fumble).",
    "C# Class");

// Penalty system
var preSnapPenaltyCheck = stateLibrary.AddComponent(
    "PreSnapPenaltyOccurredSkillsCheck",
    "Checks for pre-snap penalties (False Start, Offsides, Delay of Game, etc.).",
    "C# Class");
var blockingPenaltyCheck = stateLibrary.AddComponent(
    "BlockingPenaltyOccurredSkillsCheck",
    "Checks for blocking penalties (Holding, Illegal Block, Clipping, etc.).",
    "C# Class");
var coveragePenaltyCheck = stateLibrary.AddComponent(
    "CoveragePenaltyOccurredSkillsCheck",
    "Checks for coverage penalties (Pass Interference, Illegal Contact, Holding, etc.).",
    "C# Class");
var tacklePenaltyCheck = stateLibrary.AddComponent(
    "TacklePenaltyOccurredSkillsCheck",
    "Checks for tackle penalties (Facemask, Horse Collar, Unnecessary Roughness, etc.).",
    "C# Class");
var postPlayPenaltyCheck = stateLibrary.AddComponent(
    "PostPlayPenaltyOccurredSkillsCheck",
    "Checks for post-play penalties (Taunting, Unsportsmanlike Conduct, etc.).",
    "C# Class");
var penaltyEffect = stateLibrary.AddComponent(
    "PenaltyEffectSkillsCheckResult",
    "Determines specific penalty, player who committed it, yardage, acceptance.",
    "C# Class");
var penaltyEnforcement = stateLibrary.AddComponent(
    "PenaltyEnforcement (Service)",
    "Enforces penalties: calculates net yards, determines acceptance, handles offsetting, updates down/distance.",
    "C# Class");

// Injury system
var injuryOccurredCheck = stateLibrary.AddComponent(
    "InjuryOccurredSkillsCheck",
    "Determines if injury occurs based on fragility, play type, gang tackles, big plays, position.",
    "C# Class");
var injuryEffect = stateLibrary.AddComponent(
    "InjuryEffectSkillsCheckResult",
    "Determines injury type (Ankle/Knee/Shoulder/Concussion/Hamstring), severity (Minor/Moderate/GameEnding), recovery time.",
    "C# Class");

// Configuration
var gameProbabilities = stateLibrary.AddComponent(
    "GameProbabilities",
    "Constants for game probabilities (completion %, fumble rates, etc.).",
    "C# Class");
var injuryProbabilities = stateLibrary.AddComponent(
    "InjuryProbabilities",
    "Constants for injury probabilities by play type, position, multipliers.",
    "C# Class");

// Services
var statsAccumulator = stateLibrary.AddComponent(
    "StatsAccumulator (Service)",
    "Accumulates player stats (passing, rushing, receiving, tackles, etc.).",
    "C# Class");

// Calculators
var lineBattleCalc = stateLibrary.AddComponent(
    "LineBattleCalculator",
    "Calculates O-line vs D-line effectiveness for blocking/protection.",
    "C# Class");
var teamPowerCalc = stateLibrary.AddComponent(
    "TeamPowerCalculator",
...
void WriteView(View view, string filename)
{
    ...
    using (var writer = new StreamWriter(fullPath))
    {
        switch (view)
        {
            case SystemLandscapeView v:
                plantUmlWriter.Write(v, writer);
                break;
            case SystemContextView v:
                plantUmlWriter.Write(v, writer);
                break;
            case ContainerView v:
                plantUmlWriter.Write(v, writer);
                break;
            case ComponentView v:
                plantUmlWriter.Write(v, writer);
                break;
        }
    }
